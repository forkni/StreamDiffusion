...
class RealESRGANProcessor(BasePreprocessor):
    ...
    def _load_pytorch_model(self):
        ...
        model_dtype = next(self.pytorch_model.parameters()).dtype  # noqa: F841  # TODO: pre-existing, untouched by this refactor
    ...
    def _process_with_pytorch(self, tensor: torch.Tensor) -> torch.Tensor:
        ...
        original_dtype = tensor.dtype  # noqa: F841  # TODO: pre-existing, untouched by this refactor
