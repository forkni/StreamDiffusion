...
class EngineBuilder:
    ...
    def build(
        ...
        # Cleanup ONNX artifacts — preserve .engine, calib_data.npz, unet.fp8.onnx* files, timing.cache, build_stats.json
        ...
        for file in os.listdir(engine_dir):
            # Keep all files that are part of the FP8 quantized ONNX artifact
            # (unet.fp8.onnx and any external data companion like unet.fp8.onnx.data)
            if "fp8.onnx" in file:
                continue
